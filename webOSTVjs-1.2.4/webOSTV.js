					...
					var r = function (n, r) {
							if (!n && r)
								try {
									...
									console.error(
										'Unable to parse appinfo.json file for',
										t()
									),
										e && e();
								}
							...
							new m().send({
								...
								onComplete: function (n) {
									if (
										...
										(j.oled =
											'OLED' === n.configs['tv.hw.displayType']),
										(j.ddrSize = n.configs['tv.hw.ddrSize']),
										(j.hdr10 =
											!0 === n.configs['tv.model.supportHDR']),
										(j.dolbyVision =
											!0 ===
											n.configs[
												'tv.config.supportDolbyHDRContents'
									...
									!n.returnValue || n.missingConfigs
										? n.missingConfigs &&
										  1 === n.missingConfigs.length &&
										  'tv.model.supportTemp8K' === n.missingConfigs[0]
											? e(j)
											: new m().send({
													service:
													...
													onComplete: function (n) {
														if (
															((j.modelName =
																n.modelName || j.modelName),
															(j.sdkVersion =
																n.sdkVersion || j.sdkVersion),
															(j.uhd = n.UHD
																? 'true' === n.UHD
																: j.uhd),
															(j.oled = n.OLED
